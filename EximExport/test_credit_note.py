...
def Creditnoteupload(driver,file_path=r"D:\Testing Plan for Web Application.pdf"):
...
def Creditnotedata(driver):
    ...
    safe_send_keys(driver,(By.XPATH,"(//input[@type='text'])[4]"),"87547")
    ...
    safe_click(driver,"(//button[@id='CreditNoteExport'])[1]")
    #to identify and print the message
    toast_message = get_toast_alert_text(driver)
    print("message:" + toast_message)


def test_pass(driver):
    output_path = r"D:\New Python\Recorded Videos\CreditNotes.mp4"
    ...
    try:
        Creditnoteupload(driver, file_path=r"D:\New Python\CommercialInvoices_R16846.pdf")
        Creditnotedata(driver)
    finally:
        stop_event.set()
...
def test_fail(driver):
    Creditnoteupload(driver,file_path=r"D:\Downloads\visitor-guide.pdf")
