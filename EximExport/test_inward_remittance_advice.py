...
def Inwardremittanceupload(driver,file_path=r"D:\Testing Plan for Web Application.pdf"):
    #CLick the Insurance Policy menu
    safe_click(driver,"(//h6[normalize-space()='Inward Remittance Advice'])[1]")
    # CLick the add new button
    safe_click(driver,"(//button[normalize-space()='ADD NEW'])[1]")
    time.sleep(2)
    # select the dta in grid
    safe_click(driver, "(//input[@type='checkbox'])[6]")
    # File Upload
...
def Inwardremittancedata(driver):
    #CLick and select the bank
    safe_click(driver,"(//input[@type='text'])[3]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='text'])[3]"),"HDFC Bank Ltd"+Keys.ENTER)
    #Click and select the remitter name
    safe_click(driver,"(//input[@type='text'])[4]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='text'])[4]"),"HUSCO INTERNATIONAL"+Keys.ENTER)
    #Selct the remitter ref.no
    safe_click(driver,"(//span[@class='mat-checkbox-inner-container'])[1]")
    #Seelct the tt date
    safe_click(driver,"(//input[@type='date'])[3]")
    safe_send_keys(driver, (By.XPATH, "(//input[@type='date'])[3]"), "1812")
    actions = ActionChains(driver)
    actions.send_keys(Keys.TAB).perform()
    actions.send_keys("2024").perform()
    #Click and enter the Forex Advice no.
    safe_click(driver,"(//input[@type='text'])[5]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='text'])[5]"),"5003")
    #Click and enter the Currency
    safe_click(driver,"(//input[@type='text'])[6]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='text'])[6]"),"ALL"+Keys.ENTER)
    #Click and enter the TT Amount
    safe_click(driver,"(//input[@type='textbox'])[1]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='textbox'])[1]"),"5000")
    #CLick and enter the handling charges
    safe_click(driver,"(//input[@type='textbox'])[2]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='textbox'])[2]"),"2000")
    #CLick and enter the Exchange rate
    safe_click(driver,"(//input[@type='textbox'])[3]")
    safe_send_keys(driver,(By.XPATH,"(//input[@type='textbox'])[3]"),"1000")
    #CLick the submit button
    safe_click(driver,"(//button[@id='InwardRemittanceAdvice'])[1]")
    #CLick the ok button
    safe_click(driver,"(//button[normalize-space()='Ok'])[1]")
    # to print the message
    toast_message = get_toast_alert_text(driver)
    print("message:" + toast_message)

def test_pass(driver):
    output_path = r"D:\New Python\Recorded Videos\InwardRemittanceAdvice.mp4"
    ...
    try:
        Inwardremittanceupload(driver, file_path=r"D:\New Python\samplePDFFile (1).pdf")
...
def test_fail(driver):
    Inwardremittanceupload(driver,file_path=r"D:\Downloads\2020_Taiwan_Tourism_Guide_Book_(E).pdf")
